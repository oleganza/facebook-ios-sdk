# https://raw.github.com/oleganza/facebook-ios-sdk/podspecs/3.9.0/Facebook-iOS-SDK.podspec
Pod::Spec.new do |s|
  ...
  s.author       =  'Facebook'
  s.source       =  { :git => 'https://github.com/oleganza/facebook-ios-sdk.git', :tag => 'sdk-version-3.9.0-short-timeout' }
